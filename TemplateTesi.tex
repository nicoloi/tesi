...
\end{figure}
In questo albero, la radice è il nodo ``$->$'', perchè è il connettivo principale della formula dell'esempio. I nodi ``$\thicksim$'' hanno solo il figlio sinistro perchè rappresentano la negazione, e le foglie sono le atomiche \emph{a, b, c, d}.
